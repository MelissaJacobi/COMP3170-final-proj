  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <ul>
          <p>Contact us</p>
          <li><SlPhone  className={styles.socialIcon}/>Facebook</li>
          <li><MdOutlineMailOutline className={styles.socialIcon}/>Twitter</li>
          <li><MdOutlineLocationOn className={styles.socialIcon}/>Instagram</li>
        </ul>
      </div>
    </>
  )
